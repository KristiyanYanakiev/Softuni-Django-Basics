...
from department.views import home_view, show_department_by_name, index, slug_view, path_view, uuid_view, \
    view_types_home_view, redirect_view, IndexView, dashboard_view, MyRedirectView, AddDepartmentView, \
    EditDepartmentView, DeleteDepartmentView
...
urlpatterns = [
    ...
    path('create/', AddDepartmentView.as_view(), name='create'),
    path('<int:pk>/edit/', EditDepartmentView.as_view()),
    path('<int:pk>/delete/', DeleteDepartmentView.as_view()),
